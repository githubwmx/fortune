...
<body>
	<div class="container">
		<input type="text" name="title" id="title" placeholder="前缀." onpaste='columnAlias(this)'></input>
		<textarea style="width: 100%;height: 300px;" onpaste='columnAlias(this)' autofocus></textarea>
		<br><br>
